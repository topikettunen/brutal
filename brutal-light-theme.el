;;; brutal-light-theme.el --- Brutalist theme -*- lexical-binding: t; -*-
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:bold t :foreground ,bg1 :background "black"))))
   `(mode-line-inactive ((,class (:foreground ,fg4 :background ,bg2 :weight normal))))
   `(mode-line-buffer-id ((,class (:bold t :foreground ,bg1 :background nil))))
...
(provide-theme 'brutal-light)
(provide 'brutal-light-theme)

;;; brutal-light-theme.el ends here
